...
public class ReviewDbInitializer {
        ...
        ApplicationRunner initReviews(MovieReviewRepository reviewRepository) {
                return args -> {
                        ...
                        lordOfTheRings1.setReview(
                                        "The sense of closure is exquisite, but I'm not sure I'm able to forgive Peter "
                                                        +
                        ...
                        lordOfTheRings2.setReview(
                                        "The Return Of The King ultimately proves up to the series' increasingly difficult"
                                                        +
                        ...
                        theLastSamurai1.setReview(
                                        "It's easy to stand back and wax ironic about The Last Samurai. But it's not all "
                                                        +
                        ...
                        theLastSamurai2.setReview(
                                        "Mostly, though, The Last Samurai aims for, and achieves, epic sweep: the glory of"
                                                        +
